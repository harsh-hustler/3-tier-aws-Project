...
```bash
git clone https://github.com/harsh-hustler/3-tier-aws-Project.git
```

1. 3-tier-aws-project-8235 (upload your content)  
2. 3tier-vpc-flow-log-8235 (attach this bucket immediately) with arn Value [ arn:aws:s3:::3tier-vpc-flow-log-8235 ]
